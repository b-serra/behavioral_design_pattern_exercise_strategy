...
def main() -> None:
    ...
    parser.add_argument("--strategy", type=str, default="none",
                        choices=["none", "percent", "bulk", "composite", "subtotal-threshold-percent"],
                        help="Strategy kind")
    parser.add_argument("--percent", type=float, default=0.0, help="Percent discount for 'percent' or 'composite'")
    parser.add_argument("--threshold-amount", type=float, default=0.0, dest="threshold_amount",
                        help="Subtotal threshold for 'subtotal-threshold-percent'")
